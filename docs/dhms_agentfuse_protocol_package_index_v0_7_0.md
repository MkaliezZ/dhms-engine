...
* CLI Evidence Trace Validation v3.0.1: [`docs/dhms_cli_evidence_trace_validation_v3_0_1.md`](dhms_cli_evidence_trace_validation_v3_0_1.md)
...
* Real LangChain dependency lock: [`requirements.txt`](../requirements.txt)
...
* Real LangChain dependency and agent harness validation v3.1.1: [`docs/dhms_real_langchain_dependency_and_agent_harness_validation_v3_1_1.md`](dhms_real_langchain_dependency_and_agent_harness_validation_v3_1_1.md)
* Real LangChain dependency and agent harness validator: [`validation/run_dhms_langchain_dependency_and_agent_harness_validation_v0.py`](../validation/run_dhms_langchain_dependency_and_agent_harness_validation_v0.py)
* Real LangChain Pre-Tool Interception Result Review + README Sync v3.1.2: [`docs/dhms_real_langchain_pre_tool_interception_result_review_and_readme_sync_v3_1_2.md`](dhms_real_langchain_pre_tool_interception_result_review_and_readme_sync_v3_1_2.md)
* README Current Status Sync v3.1.2: [`docs/dhms_readme_current_status_sync_v3_1_2.md`](dhms_readme_current_status_sync_v3_1_2.md)
* Real LangChain agent loop boundary module: [`dhms_agentfuse/langchain_agent_loop_boundary.py`](../dhms_agentfuse/langchain_agent_loop_boundary.py)
* Real LangChain agent loop pre-tool boundary validator: [`validation/run_dhms_langchain_agent_loop_pre_tool_boundary_harness_v0.py`](../validation/run_dhms_langchain_agent_loop_pre_tool_boundary_harness_v0.py)
* Real LangChain agent loop dangerous SQL mutation example: [`examples/langchain_agent_loop/dangerous_sql_mutation_tool_call.json`](../examples/langchain_agent_loop/dangerous_sql_mutation_tool_call.json)
* Real LangChain Agent Loop Pre-Tool Boundary Harness v3.2.0: [`docs/dhms_real_langchain_agent_loop_pre_tool_boundary_harness_v3_2_0.md`](dhms_real_langchain_agent_loop_pre_tool_boundary_harness_v3_2_0.md)
* Real LangChain Agent Loop Boundary Validation v3.2.1: [`docs/dhms_real_langchain_agent_loop_boundary_validation_v3_2_1.md`](dhms_real_langchain_agent_loop_boundary_validation_v3_2_1.md)
* Real LangChain agent loop boundary validator: [`validation/run_dhms_langchain_agent_loop_boundary_validation_v0.py`](../validation/run_dhms_langchain_agent_loop_boundary_validation_v0.py)
* Real LangChain agent loop boundary validation assertion records v3.2.1: [`docs/dhms_real_langchain_agent_loop_boundary_validation_assertion_records_v3_2_1.md`](dhms_real_langchain_agent_loop_boundary_validation_assertion_records_v3_2_1.md)
* Real LangChain Agent Loop Boundary Result Review + README Sync v3.2.2: [`docs/dhms_real_langchain_agent_loop_boundary_result_review_and_readme_sync_v3_2_2.md`](dhms_real_langchain_agent_loop_boundary_result_review_and_readme_sync_v3_2_2.md)
* README Current Status Sync v3.2.2: [`docs/dhms_readme_current_status_sync_v3_2_2.md`](dhms_readme_current_status_sync_v3_2_2.md)
* Real LangChain guarded tool adapter module: [`dhms_agentfuse/langchain_guarded_tool_adapter.py`](../dhms_agentfuse/langchain_guarded_tool_adapter.py)
* Real LangChain guarded tool adapter boundary validator: [`validation/run_dhms_langchain_guarded_tool_adapter_boundary_v0.py`](../validation/run_dhms_langchain_guarded_tool_adapter_boundary_v0.py)
* LangChain guarded adapter safe read-only example: [`examples/langchain_guarded_tool_adapter/safe_read_only_summary_tool_call.json`](../examples/langchain_guarded_tool_adapter/safe_read_only_summary_tool_call.json)
...
* Real LangChain multi-tool selective interception validator v3.4.1: [`validation/run_dhms_langchain_multi_tool_selective_interception_validation_v0.py`](../validation/run_dhms_langchain_multi_tool_selective_interception_validation_v0.py)
...
* langgraph-bigtool registry-pattern guard demo v3.5.1: [`docs/dhms_external_langchain_langgraph_integration_example_v3_5_1.md`](dhms_external_langchain_langgraph_integration_example_v3_5_1.md)
* langgraph-bigtool registry-pattern example README v3.5.1: [`examples/external_integrations/langgraph_bigtool/README.md`](../examples/external_integrations/langgraph_bigtool/README.md)
* langgraph-bigtool registry-pattern demo v3.5.1: [`examples/external_integrations/langgraph_bigtool/dhms_guarded_tool_registry_demo.py`](../examples/external_integrations/langgraph_bigtool/dhms_guarded_tool_registry_demo.py)
* Real langgraph-bigtool API wiring demo v3.5.2: [`docs/dhms_real_langgraph_bigtool_api_wiring_demo_v3_5_2.md`](dhms_real_langgraph_bigtool_api_wiring_demo_v3_5_2.md)
* Real langgraph-bigtool API wiring example README v3.5.2: [`examples/external_integrations/langgraph_bigtool/README.md`](../examples/external_integrations/langgraph_bigtool/README.md)
* Real langgraph-bigtool API wiring demo script v3.5.2: [`examples/external_integrations/langgraph_bigtool/dhms_guarded_tool_registry_demo.py`](../examples/external_integrations/langgraph_bigtool/dhms_guarded_tool_registry_demo.py)
...
v1.3.6 records the completed manual GitHub release confirmation for the v1.3
Runtime Adapter Boundary Public Evidence Package. It is documentation/release
confirmation only and does not add runtime adapter implementation, SDK
integration, execution behavior, source code changes, or frozen evidence
artifact changes.
