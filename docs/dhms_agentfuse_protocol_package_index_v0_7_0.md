...
* External LangChain/LangGraph integration example v3.5.1: [`docs/dhms_external_langchain_langgraph_integration_example_v3_5_1.md`](dhms_external_langchain_langgraph_integration_example_v3_5_1.md)
* External integration example README v3.5.1: [`examples/external_integrations/langgraph_bigtool/README.md`](../examples/external_integrations/langgraph_bigtool/README.md)
* External integration demo v3.5.1: [`examples/external_integrations/langgraph_bigtool/dhms_guarded_tool_registry_demo.py`](../examples/external_integrations/langgraph_bigtool/dhms_guarded_tool_registry_demo.py)
