...
from provider_response_parsers import parse_openai_responses
...
class OpenAIModel(BaseAPIModel):
    ...
    def generate(self, input_text: str, regime: str, memory_condition: Mapping[str, Any]) -> str:
        ...
        payload = {"model": self.model_name, "input": input_text, "temperature": 0}
        try:
            ...
            return parse_openai_responses(data)
