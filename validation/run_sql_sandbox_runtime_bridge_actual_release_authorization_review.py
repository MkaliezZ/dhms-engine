#!/usr/bin/env python3
"""Run the v0.5.12 SQL sandbox bridge actual-release authorization review."""
...
def main() -> int:
    ...
    result = run_sql_sandbox_runtime_bridge_actual_release_authorization_review()
    failed_preflights = [
        preflight["script"]
    ...
    if failed_preflights:
        ...
        result["status"] = "FAIL"
        result["final_verdict"] = "NEEDS_SQL_SANDBOX_RUNTIME_BRIDGE_ACTUAL_RELEASE_AUTHORIZATION_REVIEW_FIX"
