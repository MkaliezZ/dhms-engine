#!/usr/bin/env python3
"""Run the v0.5.11 SQL sandbox bridge controlled-release stub validation."""
...
def main() -> int:
    ...
    result = run_sql_sandbox_runtime_bridge_first_controlled_release_stub()
    failed_preflights = [
        preflight["script"]
    ...
    if failed_preflights:
        ...
        result["status"] = "FAIL"
        result["final_verdict"] = "NEEDS_SQL_SANDBOX_RUNTIME_BRIDGE_CONTROLLED_RELEASE_STUB_FIX"
