#!/usr/bin/env python3
"""Run the v0.5.9 SQL sandbox bridge held-release review validation."""
...
def main() -> int:
    ...
    result = run_sql_sandbox_runtime_bridge_first_held_release_review()
    failed_preflights = [
        preflight["script"]
    ...
    if failed_preflights:
        ...
        result["status"] = "FAIL"
        result["final_verdict"] = "NEEDS_SQL_SANDBOX_RUNTIME_BRIDGE_HELD_RELEASE_REVIEW_FIX"
